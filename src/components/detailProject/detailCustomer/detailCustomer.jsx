...
import L_EXPRESS from "../../../assets/img/skills/express.svg";import L_REACT_ROUTER from "../../../assets/img/skills/react-router.svg";
    ...
    return (
        ...
        >
            ...
            <div className="box-modal">
                    <h1>E-commerce Customer</h1>
                    <strong>Description:</strong> Aplikasi privat admin
                        online shop untuk Membeli barang, Menambah, mengedit, dan menghapus
                        produk yg di keranjang pembelian
                        <hr />
