                  ...
                  {skills.frontend.map((skill, index) => (
                    <span className="p-2" key={index}>
                      <a className="text-dark text-decoration-none" href={skill.link} target="_blank" rel="noopener noreferrer">
                        <Image src={skill.image} alt={skill.name} rounded className="image-style m-1"></Image> {skill.name}
                      </a>
                    </span>
                  ))}
                </Card.Text>
                ...
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  <span className="p-2">
                    <a className="text-dark text-decoration-none" href={skills.versionControl[0].link} target="_blank" rel="noopener noreferrer">
                      <Image src={skills.versionControl[0].image} alt={skills.versionControl[0].name} rounded className="image-style m-1"></Image> {skills.versionControl[0].name}
                    </a>
                  </span>
                </Card.Text>
              </Card.Body>
